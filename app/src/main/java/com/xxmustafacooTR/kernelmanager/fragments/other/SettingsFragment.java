 ...
 *
 */
package com.xxmustafacooTR.kernelmanager.fragments.other;
...
import com.xxmustafacooTR.kernelmanager.services.boot.ApplyOnBootService;
import com.xxmustafacooTR.kernelmanager.utils.AppSettings;
import com.xxmustafacooTR.kernelmanager.utils.Themes;
...
import com.xxmustafacooTR.kernelmanager.views.BorderCircleView;
    ...
    private void resetDataDialog(){
        ...
        alert.setPositiveButton(getString(R.string.ok), (dialog, id) -> {
            ...
            alert2.setNegativeButton(getString(R.string.cancel), (dialogInterface, i) -> {
                ...
                RootUtils.runCommand("pm clear com.xxmustafacooTR.kernelmanager");
            });
            alert2.setPositiveButton(getString(R.string.ok), (dialog1, id1) -> {
                RootUtils.runCommand("rm -rf /data/.kernelmanager");
                RootUtils.runCommand("pm clear com.xxmustafacooTR.kernelmanager && reboot");
            });
            alert2.show();
        });
        alert.show();
